    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown " style="list-style-type: none;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="background-color:#CCE5FF">
                           <a class="dropdown-item" href="index.php?lang=am">completed projects</a> 
                           <a class="dropdown-item" href="index.php?lang=en">Ongoing projects</a>
                           <a class="dropdown-item" href="index.php?lang=en">Terminated Projects</a>
                           <a class="dropdown-item" href="index.php?lang=en">Announced Projects</a>
